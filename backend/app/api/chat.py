...
from app.core.database import get_db, get_trip_repo, get_user_repo, get_request_repo
...
async def get_or_create_conversation(
    ...
    if is_driver:
        ...
        requests = await request_repo.list_by_trip(trip_uuid)
        ...
        requests = await request_repo.list_by_passenger(current_user.id)
        trip_request = next(
